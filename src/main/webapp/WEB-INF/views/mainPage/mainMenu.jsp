          ...
          <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarColor03">
              <ul class="navbar-nav me-auto">
                <li class="nav-item">
                  <a class="nav-link active" href="javascript: main();"
                    >Home
                    <span class="visually-hidden">(current)</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: teamVita500();"
                    >Team Vita500</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: curation()"
                    >맛집추천</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: oneKmMap()"
                    >반경1km</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: magazine();"
                    >Magazine</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: myPage();">My Page</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: shopDetail();"
                    >임시_상세</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript: detailMap();"
                    >임시_상세맵</a
                  >
                </li>
              </ul>
