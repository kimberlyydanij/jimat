...
<body>
	<form name="frm" id="frm">
		...
		<input type="text" name="review_main_number" value="2" hidden=hidden>
		<input type="text" name="review_read_count_number" value="0" hidden=hidden>
		<input type="text" name="review_tag_number" value="0" hidden=hidden>
