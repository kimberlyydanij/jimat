	...
	<c:set var="review_dto" value="${review_dto}" />
		<form id="frm" method="post" enctype="multipart/form-data">
								...
								<div class="comment-tag">
									<div class="btn-group" role="group"
										...
										<input type="checkbox" class="btn-check" name="btnradio"
											...
											class="btn-check" name="btnradio" id="mood"
											autocomplete="off" /> <label class="btn btn-outline-primary"
											for="mood">#분위기</label> <input type="checkbox"
											class="btn-check" name="btnradio" id="parking"
					...
					<div class="row" id="row2">
						<div class="comment-area p-0">
							<textarea class="form-control" name="review_content"
								rows="3">${review_dto.review_content}</textarea>
						</div>
					</div>
			...
			<input type="text" name="review_writer_id"
				...
				name="review_foodstore_seq" value="${review_dto.review_foodstore_seq}"
				hidden=hidden> 
		</form>
</body>
</html>